...
- samples
  - : A {{domxref("GLsizei")}} specifying the number of samples to be used for the
    renderbuffer storage.
- internalFormat

  - : A {{domxref("GLenum")}} specifying the internal format of the renderbuffer. Possible
...
- width
  - : A {{domxref("GLsizei")}} specifying the width of the renderbuffer in pixels.
- height
  - : A {{domxref("GLsizei")}} specifying the height of the renderbuffer in pixels.
