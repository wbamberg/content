...
- `internalformat`
  ...
  - : A {{domxref("GLint")}} specifying the color components in the texture. Possible
    values:
...
- `format`
  - : A {{domxref("GLenum")}} specifying the format of the texel data. The correct
...
- offset
  - : A {{domxref("GLintptr")}} byte offset into the {{domxref("WebGLBuffer")}}'s data
