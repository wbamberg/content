...
- `pname`
  - : A {{domxref("GLenum")}} specifying which parameter value to return. See below for
    possible values.
...
| `gl.DRAW_BUFFERi`                                  | {{domxref("GLenum")}}                               | `gl.BACK`, `gl.NONE` or `gl.COLOR_ATTACHMENT{0-15}`. See also {{domxref("WebGL2RenderingContext/drawBuffers", "drawBuffers")}}.                    |
...
| `gl.FRAGMENT_SHADER_DERIVATIVE_HINT`               | {{domxref("GLenum")}}                               | `gl.FASTEST`, `gl.NICEST` or `gl.DONT_CARE`. See also {{domxref("WebGLRenderingContext/hint", "hint")}}.                                                |
...
| `gl.PACK_ROW_LENGTH`                               | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
| `gl.PACK_SKIP_PIXELS`                              | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
| `gl.PACK_SKIP_ROWS`                                | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
...
| `gl.UNIFORM_BUFFER_OFFSET_ALIGNMENT`               | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
| `gl.UNPACK_IMAGE_HEIGHT`                           | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
| `gl.UNPACK_ROW_LENGTH`                             | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
| `gl.UNPACK_SKIP_IMAGES`                            | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
| `gl.UNPACK_SKIP_PIXELS`                            | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
| `gl.UNPACK_SKIP_ROWS`                              | {{domxref("GLint")}}                               | See {{domxref("WebGLRenderingContext/pixelStorei", "pixelStorei")}}.                                                                              |
