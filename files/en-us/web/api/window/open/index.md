...
<table class="standard-table">
  <tbody>
    ...
    <tr>
      <td>
        <img alt="New window icon from yahoo.com" src="newwindowyahoo.png" />
      </td>
      <td>
        <img alt="New window icon from microsoft.com" src="newwinmsie.gif" />
      </td>
      <td>
        <img
      ...
      <td>
        <img alt="New window icon from sun.com" src="popupimagesun.gif" />
      </td>
    </tr>
    <tr>
      <td>
        <img alt="New window icon from bbc.co.uk" src="opennews_rb.gif" />
      </td>
      <td>
        <img
    ...
    <tr>
      <td>
        <img alt="New window icon from an unknown source" src="popicon_1.gif" />
      </td>
      <td>
        <img alt="New window icon from an unknown source" src="new.gif" />
      </td>
      <td>
        <img
